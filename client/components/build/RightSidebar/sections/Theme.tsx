...
const Theme = () => {
  ...
  const { background, text, primary, secondary } = useAppSelector<ThemeConfig>((state) =>
  ...
  return (
    <>
      ...
      <div className={styles.container}>
        ...
        />
        {/* <ColorPicker
          label={t<string>('builder.rightSidebar.sections.theme.form.secondary.label')}
          color={secondary}
          className="col-span-2"
          onChange={(color) => handleChange('secondary', color)}
        /> */}
        <ColorPicker
