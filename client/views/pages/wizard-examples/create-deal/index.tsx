...
import StepDealDetails from './../../../../views/pages/wizard-examples/create-deal/StepDealDetails';
// ** Step Components
import StepDealType from './../../../../views/pages/wizard-examples/create-deal/StepDealType';
import StepDealUsage from './../../../../views/pages/wizard-examples/create-deal/StepDealUsage';
import StepReview from './../../../../views/pages/wizard-examples/create-deal/StepReview';
