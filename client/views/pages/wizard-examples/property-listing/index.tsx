...
import StepPersonalDetails from './../../../../views/pages/wizard-examples/property-listing/StepPersonalDetails';
import StepPriceDetails from './../../../../views/pages/wizard-examples/property-listing/StepPriceDetails';
// ** Step Components
import StepPropertyArea from './../../../../views/pages/wizard-examples/property-listing/StepPropertyArea';
import StepPropertyDetails from './../../../../views/pages/wizard-examples/property-listing/StepPropertyDetails';
import StepPropertyFeatures from './../../../../views/pages/wizard-examples/property-listing/StepPropertyFeatures';
